...
set_multicycle_path -from ${topmodule}m92|v30|* -to ${topmodule}m92|v30|regs.* -setup 2
set_multicycle_path -from ${topmodule}m92|v30|* -to ${topmodule}m92|v30|regs.* -hold 1
set_multicycle_path -from ${topmodule}m92|v30|* -to ${topmodule}m92|v30|bus_datawrite[*] -setup 2
set_multicycle_path -from ${topmodule}m92|v30|* -to ${topmodule}m92|v30|bus_datawrite[*] -hold 1
set_multicycle_path -from ${topmodule}m92|v30|* -to ${topmodule}m92|v30|bus_addr[*] -setup 2
set_multicycle_path -from ${topmodule}m92|v30|* -to ${topmodule}m92|v30|bus_addr[*] -hold 1

set_multicycle_path -from ${topmodule}m92|sound|v35|core|* -to ${topmodule}m92|sound|v35|core|regs.* -setup 2
set_multicycle_path -from ${topmodule}m92|sound|v35|core|* -to ${topmodule}m92|sound|v35|core|regs.* -hold 1
set_multicycle_path -from ${topmodule}m92|sound|v35|core|* -to ${topmodule}m92|sound|v35|core|bus_datawrite[*] -setup 2
set_multicycle_path -from ${topmodule}m92|sound|v35|core|* -to ${topmodule}m92|sound|v35|core|bus_datawrite[*] -hold 1
set_multicycle_path -from ${topmodule}m92|sound|v35|core|* -to ${topmodule}m92|sound|v35|core|bus_addr[*] -setup 2
set_multicycle_path -from ${topmodule}m92|sound|v35|core|* -to ${topmodule}m92|sound|v35|core|bus_addr[*] -hold 1
