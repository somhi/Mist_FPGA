...
set sdram2_clk "pll_rot|altpll_component|auto_generated|pll1|clk[0]"
set mem2_clk   "pll_rot|altpll_component|auto_generated|pll1|clk[1]"
...
set_multicycle_path -from [get_clocks $game_clk] -to [get_clocks $mem_clk] -end -setup 2
set_multicycle_path -from [get_clocks $game_clk] -to [get_clocks $mem_clk] -end -hold 1

set_multicycle_path -from {F2:F2|audio_mix:audio_mix|IIR_filter:*} -to {F2:F2|audio_mix:audio_mix|IIR_filter:*} -setup 2
set_multicycle_path -from {F2:F2|audio_mix:audio_mix|IIR_filter:*} -to {F2:F2|audio_mix:audio_mix|IIR_filter:*} -hold 1
