...
set_output_delay -add_delay  -clock_fall -clock [get_clocks $vid_clk]  1.000 [get_ports {AUDIO_L}]
set_output_delay -add_delay  -clock_fall -clock [get_clocks $vid_clk]  1.000 [get_ports {AUDIO_R}]
