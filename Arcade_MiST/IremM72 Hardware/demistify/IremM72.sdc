...
set vid_clk   "${topmodule}pll|altpll_component|auto_generated|pll1|clk[1]"
set game_clk  "${topmodule}pll|altpll_component|auto_generated|pll1|clk[1]"
set sdram_clk "${topmodule}pll|altpll_component|auto_generated|pll1|clk[2]"
...
set_multicycle_path -from ${topmodule}m72|mcu|mc8051|*  -setup 2
set_multicycle_path -from ${topmodule}m72|mcu|mc8051|*  -hold 1
set_multicycle_path -from ${topmodule}m72|mcu|prom|ram_rtl_0|* -to ${topmodule}m72|mcu|mc8051|i_mc8051_control|* -setup 2
set_multicycle_path -from ${topmodule}m72|mcu|prom|ram_rtl_0|* -to ${topmodule}m72|mcu|mc8051|i_mc8051_control|* -hold 1
